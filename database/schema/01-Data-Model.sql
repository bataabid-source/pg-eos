...
-- وثيقة 01 من 09 · PostgreSQL 16 · الإصدار 1.0 · 19/09/2026
--
...
-- إعادة بناء رصيد المخزون من الدفتر ومقارنته (P4)
create or replace function wms.verify_balance_integrity()
returns table (client_id uuid, sku_id uuid, location_id uuid,
...
language sql stable as $$
  ...
  select l.client_id, l.sku_id, l.loc, l.qty,
         coalesce(b.qty_on_hand, 0), l.qty - coalesce(b.qty_on_hand, 0)
  from ledger l
  left join wms.stock_balance b
    on b.client_id = l.client_id and b.sku_id = l.sku_id and b.location_id = l.loc
  where l.qty <> coalesce(b.qty_on_hand, 0)
$$;
comment on function wms.verify_balance_integrity is 'يجب أن يعيد صفر صفوف. أي صف = يوقف النشر';
