...
| wms/integration | 1 | 2.11 | 2026-09-25 | ../pg-eos-lane-1 (2.11 part 2 DONE-in-part @ `<this commit>` — tests-only grant: `modules/wms/tests/integration/location-limits.test.ts` `pickWh1Location` (WBS 2.4) still selects orphan shared rows by `order by code desc limit 1`; fix carried to part 3, not done this part; no domain/application/api file) |
