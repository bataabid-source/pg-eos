...
| billing | 2 | 4.2 | 2026-09-25 | ../pg-eos-lane-2 (4.2 part 1 DONE-in-part @ `<this commit>` — domain value object/factory + infrastructure repository insert `insertBillableEvent`, PASS(23 findings, 2 rounds); part 2 open — pg-reviewer confirmation of the SQLSTATE 23505 test, mutation-proven, reviewed in 4.1a's own round 1, not a separate commit; row NOT released, lane 2 continues in `billing` for 4.1a next, D-186/D-187) |
