...
`imile` (lane 3, task 3.14 part 2) row above updates in place, not released — 3.14 part 2 DONE-in-part @ `e667821` (pull loop mechanism, PASS(27 findings/7 rounds)); lane 3 continues in the same module for **3.17** next (D-184).
