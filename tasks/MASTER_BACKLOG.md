...
| ID | Task | Type | Depends on | Lane | Owner | Acceptance | Status |
|---|---|---|---|---|---|---|---|
| 3.1 | `tms.vehicles`, documents, hard gate on expired docs | 🤖 | 0.9 | **1** | FLEET_MGR | Expired-doc vehicle cannot be assigned | IN PROGRESS — lane 3 (D-184: doc-38 lane 1 row reassigned by the GM); `modules/tms` created by new-slice.sh; budget 8 / 1,000, two rounds (D-186) |
