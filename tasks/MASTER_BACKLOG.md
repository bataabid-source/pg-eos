...
| 2.11 | Outbound order: ten-condition check, FEFO allocation, pick sequence (A3) | 🤖 | 2.9, 1.8 | **1** | WH_MGR | Each of ten conditions has a failing test with the correct message | IN PROGRESS / BLOCKED-ON-G-01 — parts 1–4 DONE (a96b013, 156b042, f30f7c7, <this commit>); naming discipline fully closed (52 describe/52 Gherkin, zero orphans); 9 of 10 conditions; condition 10 ("quantity within the agreed order limit") remains the row's sole open blocker — G-01, no order-limit source in 01/13/13B/019/40, filed `docs/notes/SCR-WMS-OUT-02-order-quantity-limit.md` — row stays open pending a GM ruling |
