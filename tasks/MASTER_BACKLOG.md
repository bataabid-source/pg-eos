...
| 2.10 | Put-away with automatic location suggestion (A2) | 🤖 | 2.9 | **1** | WH_MGR | Suggestion respects conditions, ABC, capacity, client assignment | DONE @ `<this commit>` — lane 1; golden-slice enhancement (in-place edit, no new use-case tree); hazmat/fragile/light-sensitivity conditions deferred (batched GM question, see CHANGELOG); no ABC formula for B/C class beyond 2.9's own unchanged order. |
