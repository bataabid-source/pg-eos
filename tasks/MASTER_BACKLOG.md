...
| 2.11 | Outbound order: ten-condition check, FEFO allocation, pick sequence (A3) | 🤖 | 2.9, 1.8 | **1** | WH_MGR | Each of ten conditions has a failing test with the correct message | IN PROGRESS — part 1 DONE @ `a96b013` · part 2 DONE-in-part @ `<this commit>` (Allocate/GeneratePickList/cancel-release, single-lot rule, review round 3 FAIL(1 low) carried) · **part 3 TODO**: three describe names = Gherkin names; `pickWh1Location` (2.4) fix |
