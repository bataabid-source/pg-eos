 ...
 *  null — `sales.accounts` has no `entity_id` column at all (Scope: genuinely group-level); the
 *  key row's entity scope is optional. Called only after requireIdempotencyKey already confirmed
