...
| **القرار المطلوب** | **إمّا** إنشاء وعاء الحضور والورديات في `13B` (وحينها تُفتح المؤشرات الثلاثة والإسناد بالوردية معاً)، **وإمّا** إعلان أن الإنتاجية تُقاس **بالزمن النشط للمهام فقط** بلا مقام «زمن الوردية» — وشطب المؤشرات الثلاثة من §7 — **D-132 (24/09/2026): المالك GM؛ وعاء الحضور مطلوب عبر SCR-HR-ATT-01 (معتمد، D-131)؛ الورديات تبقى مفتوحة وتُحسم بعد التجربة (D-127)** | — | ⏳ **GM** |
