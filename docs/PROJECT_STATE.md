...
- **D-176 open question answered by D-180 item 3 (Master default, GM may veto):** lane 3 continues its own doc-38 lane-3 rows (3.15, 3.16, 3.17, 3.18, 3.19) after 3.14 part 2, rather than idling.
