...
|---|---|---|---|
| 1 | 2.12 part 3 DONE @ `<this commit>` (closes SCR-WMS-OUT-03); part 4 next (Pack/Load) — 2.11 DONE, all ten conditions | `wms/process-outbound` (`wms/receive-inbound` released — 183/183 clean on `pgeos_lane1`, orphans confirmed, nothing to carry) | `../pg-eos-lane-1` |
...
| task | commit |
|---|---|
| 2.12 part 3 — `order_lines.picked_by`/`picked_at` + full self-check signal (lane 1), DONE — closes SCR-WMS-OUT-03 (D-190 option a); migration 0032 applied; 247/247 tests green, guards green; pre-migration PASS(0, 2 rounds) + slice-close PASS(0, 2 rounds); part 4 opened (Pack/Load) | `<this commit>` |
