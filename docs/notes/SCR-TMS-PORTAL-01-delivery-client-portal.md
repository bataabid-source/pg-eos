...
**Status: APPROVED — GM D-165 (2026-09-24), sheet 5 Q8–Q11; resolution in §6. Nothing in `database/schema/*` or `database/migrations/*` is touched by this note.** Raised under **EXECUTION-MASTER-v4 §1.11 (G-01)** on criterion (iii): a GM requirement not modelled in doc 40 §C10 / doc 27 §6 (the 12 portal screens). Source: GM directive of 2026-09-24, verbatim in **D-160**. Timing: Phase 6 (6.1 Client Portal, lane 1) unless the GM pulls it forward; nothing in the pilot changes.
