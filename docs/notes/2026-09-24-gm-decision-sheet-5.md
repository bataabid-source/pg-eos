...
## Answers — GM 2026-09-24, recorded as D-167
...
Applied per D-167 in `docs/DECISION_LOG.md`. Q2–Q4: commission is configuration with a worked-example preview; Q5 isolated for the GM; Q7 all seven deleted; Q15 APP-1 = 5.3b.
