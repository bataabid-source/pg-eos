...
| 9 | new `billing.dimension_types`, new `billing.line_dimensions` | Dimensions as data; backs the fixed `client_id/contract_id/cost_center` (01:1208-1210) | §6, §2 | D1 6 · D2 (d) | requested |
