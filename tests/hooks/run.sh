...
expect "duplicate lock refused"                 1 "$(cl '| wms | 1 | a | d | ../pg-eos-lane-1 |\n| wms | 2 | b | d | ../pg-eos-lane-2 |')"
expect "whole + use-case clash refused"         1 "$(cl '| wms | 2 | a | d | ../pg-eos-lane-2 |\n| wms/put-away | 1 | b | d | ../pg-eos-lane-1 |')"
expect "four lanes refused"                     1 "$(cl '| a | 1 | t | d | ../pg-eos-lane-1 |\n| b | 2 | t | d | ../pg-eos-lane-2 |\n| c | 3 | t | d | ../pg-eos-lane-3 |\n| e | A | t | d | ../pg-eos-lane-A |')"
