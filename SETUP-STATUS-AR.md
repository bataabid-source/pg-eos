...
| X — قرارات GM 2026-09-23 (D-105…D-112): توحيد الصورة، نقل الملخصات، بيئة turbo، كلمة مرور pgAdmin، تزامن الوثائق | ⏭️ المهمة الحالية | — |
...
2. `claude` → `/model sonnet` → `/resume` — **دائماً من داخل `claude-kit/`** وليس من المجلد الأعلى `PG-EOS/`.
